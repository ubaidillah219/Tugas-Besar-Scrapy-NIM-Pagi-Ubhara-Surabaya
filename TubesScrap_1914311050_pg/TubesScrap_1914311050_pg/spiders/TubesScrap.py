...
class QuotesSpider(scrapy.Spider):
    ...
    def parse_chaper(self,response):
        ...
        if len(self.daftar_kata_novel) == 49 :
            print('Kata yang Telah Terambil dari novel 21')
            for kata in range(0,10):
                print(self.daftar_kata_novel[kata])

            print('Kata yang Telah Terambil dari novel 22')
            for kata in range(10,20):
                print(self.daftar_kata_novel[kata])
            
            print('Kata yang Telah Terambil dari novel 23')
            for kata in range(20,30):
                print(self.daftar_kata_novel[kata])

            print('Kata yang Telah Terambil dari novel 24')
            for kata in range(30,40):
                print(self.daftar_kata_novel[kata])

            print('Kata yang Telah Terambil dari novel 25')
